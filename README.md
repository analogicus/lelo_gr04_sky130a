...
- [How](#how)
  ...
  - [Layout](#layout)
    - [Analog](#analog)
    - [Digital](#digital)
    - [TinyTapeout block](#tinytapeout-block)
- [What](#what)
...
![Oscillator_Tl](./assets/osc_1.png)

![Oscillator_Tt](./assets/osc_2.png)

![Oscillator_Th](./assets/osc_3.png)
...
![Bandgap layout](./assets/lay_bg.png)
...
![Bandgap layout](./assets/lay_osc.png)
...
The digital layout is generated by the Librelane classic flow, using the default Google Colab notebook. The resulting notebook, as well as other generated files, is stored in [./rtl](./rtl).
The pin list and other configurations are set up near the beginning of the notebook.
...
![Digital layout](./assets/lay_dig.png)
