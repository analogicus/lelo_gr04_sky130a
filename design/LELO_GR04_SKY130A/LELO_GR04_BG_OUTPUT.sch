...
N 220 -460 260 -460 {lab=PWRUP_N_1V8}
N 220 -460 220 -340 {lab=PWRUP_N_1V8}
N 240 -440 240 -420 {lab=VSS}
N 240 -440 260 -440 {lab=VSS}
...
C {LELO_GR04_SKY130A/LELO_GR04_BG_OTA_PMOS.sym} 410 -480 0 0 {name=xA}
...
C {devices/lab_wire.sym} 260 -500 0 0 {name=p8 sig_type=std_logic lab=VIN_N}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_12C1F2.sym} 680 -580 0 0 {name=xD }
