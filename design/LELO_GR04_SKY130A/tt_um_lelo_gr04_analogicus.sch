...
N -240 -190 -170 -190 {lab=ui_in[0]}
N -240 -210 -240 -190 {lab=ui_in[0]}
...
C {devices/lab_wire.sym} 60 -710 0 1 {name=p14 sig_type=std_logic lab=ui_in[2]}
C {devices/lab_wire.sym} 60 -670 0 1 {name=p15 sig_type=std_logic lab=uo_out[0]}
C {devices/lab_wire.sym} 60 -650 0 1 {name=p16 sig_type=std_logic lab=ui_in[0]}
C {devices/lab_wire.sym} 60 -630 0 1 {name=p17 sig_type=std_logic lab=ui_in[1]}
C {devices/lab_wire.sym} 60 -610 0 1 {name=p18 sig_type=std_logic lab=ui_in[3]}
