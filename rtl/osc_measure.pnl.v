module osc_measure (clk,
 ...
 sky130_fd_sc_hd__inv_2 _063_ (.A(\osc_counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__inv_2 _064_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__inv_2 _065_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__nor2_1 _066_ (.A(net15),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__o21a_1 _067_ (.A1(net20),
    .A2(net18),
    .B1(_044_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__and4_1 _068_ (.A(\osc_counter[3] ),
    .B(\osc_counter[2] ),
    .C(\osc_counter[1] ),
    .D(\osc_counter[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__and4_1 _069_ (.A(\osc_counter[6] ),
    .B(\osc_counter[5] ),
    .C(\osc_counter[4] ),
    .D(\state[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__and3_1 _070_ (.A(\osc_counter[1] ),
    .B(\osc_counter[0] ),
    .C(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__a31o_1 _071_ (.A1(\osc_counter[7] ),
    .A2(net13),
    .A3(_046_),
    .B1(\osc_counter[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__a41o_1 _072_ (.A1(\osc_counter[8] ),
    .A2(\osc_counter[7] ),
    .A3(net13),
    .A4(_046_),
    .B1(\state[0] ),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__and2b_1 _073_ (.A_N(_049_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__a21oi_1 _074_ (.A1(net13),
    .A2(_046_),
    .B1(\osc_counter[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__a31o_1 _075_ (.A1(\osc_counter[7] ),
    .A2(net13),
    .A3(_046_),
    .B1(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__nor2_1 _076_ (.A(_050_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__a41o_1 _077_ (.A1(\osc_counter[5] ),
    .A2(\osc_counter[4] ),
    .A3(net14),
    .A4(_045_),
    .B1(\osc_counter[6] ),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__a21oi_1 _078_ (.A1(net13),
    .A2(_046_),
    .B1(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__and2_1 _079_ (.A(_052_),
    .B(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__a31o_1 _080_ (.A1(\osc_counter[4] ),
    .A2(net14),
    .A3(net13),
    .B1(_042_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__nand4_1 _081_ (.A(_042_),
    .B(\osc_counter[4] ),
    .C(net14),
    .D(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__a21oi_1 _082_ (.A1(_054_),
    .A2(_055_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__a21oi_1 _083_ (.A1(net14),
    .A2(net13),
    .B1(\osc_counter[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__a31o_1 _084_ (.A1(\osc_counter[4] ),
    .A2(net14),
    .A3(net13),
    .B1(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__nor2_1 _085_ (.A(_056_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__a21o_1 _086_ (.A1(\osc_counter[2] ),
    .A2(_047_),
    .B1(\osc_counter[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__a21oi_1 _087_ (.A1(net14),
    .A2(net13),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__and2_1 _088_ (.A(_058_),
    .B(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__a21oi_1 _089_ (.A1(\osc_counter[2] ),
    .A2(_047_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__o21a_1 _090_ (.A1(\osc_counter[2] ),
    .A2(_047_),
    .B1(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a21oi_1 _091_ (.A1(\osc_counter[0] ),
    .A2(net14),
    .B1(\osc_counter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__nor3_1 _092_ (.A(net15),
    .B(_047_),
    .C(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__a21oi_1 _093_ (.A1(\osc_counter[0] ),
    .A2(net14),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__o21a_1 _094_ (.A1(\osc_counter[0] ),
    .A2(net14),
    .B1(_062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__mux2_1 _095_ (.A0(net24),
    .A1(\osc_counter[8] ),
    .S(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _096_ (.A0(net23),
    .A1(\osc_counter[7] ),
    .S(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _099_ (.A0(net26),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _100_ (.A0(net28),
    .A1(\osc_counter[3] ),
    .S(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _101_ (.A0(net22),
    .A1(\osc_counter[2] ),
    .S(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _102_ (.A0(net27),
    .A1(\osc_counter[1] ),
    .S(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__a21o_1 _103_ (.A1(net15),
    .A2(_043_),
    .B1(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and2_1 _104_ (.A(net15),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__inv_2 _105_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__inv_2 _106_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _107_ (.A(net16),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__inv_2 _108_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__inv_2 _109_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__inv_2 _110_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__inv_2 _111_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _113_ (.A(net17),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__inv_2 _114_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__inv_2 _115_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _124_ (.A(net16),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__inv_2 _125_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dfrtp_1 _133_ (.CLK(clknet_1_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net11));
 sky130_fd_sc_hd__dfstp_1 _134_ (.CLK(clknet_1_0__leaf_clk),
    .D(_001_),
    .SET_B(_010_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _137_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\state[3] ));
 sky130_fd_sc_hd__dfrtp_1 _138_ (.CLK(net1),
    .D(_032_),
    .RESET_B(_014_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[0] ));
 sky130_fd_sc_hd__dfrtp_1 _139_ (.CLK(net1),
    .D(_033_),
    .RESET_B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[1] ));
 sky130_fd_sc_hd__dfrtp_1 _140_ (.CLK(net1),
    .D(_034_),
    .RESET_B(_016_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[2] ));
 sky130_fd_sc_hd__dfrtp_1 _141_ (.CLK(net1),
    .D(_035_),
    .RESET_B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[3] ));
 sky130_fd_sc_hd__dfrtp_2 _142_ (.CLK(net1),
    .D(_036_),
    .RESET_B(_018_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[4] ));
 sky130_fd_sc_hd__dfrtp_1 _143_ (.CLK(net1),
    .D(_037_),
    .RESET_B(_019_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[5] ));
 sky130_fd_sc_hd__dfrtp_1 _144_ (.CLK(net1),
    .D(_038_),
    .RESET_B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[6] ));
 sky130_fd_sc_hd__dfrtp_1 _145_ (.CLK(net1),
    .D(_039_),
    .RESET_B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\osc_counter[7] ));
 sky130_fd_sc_hd__dfrtp_1 _146_ (.CLK(net1),
    .D(_040_),
    .RESET_B(_022_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 output12 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(pwrupOsc));
 sky130_fd_sc_hd__buf_2 fanout13 (.A(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout14 (.A(\state[1] ),
    ...
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__buf_2 fanout15 (.A(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\state[1] ),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_2 FILLER_18_26 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_18_55 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
